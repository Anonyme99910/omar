...
Route::post('/products/import/excel', [ProductImportController::class, 'importExcel']);
Route::post('/products/import/sql', [ProductImportController::class, 'importSQL']);
Route::get('/products/import/template', [ProductImportController::class, 'downloadTemplate']);
Route::get('/products/import/sql-template', [ProductImportController::class, 'getSQLTemplate']);
Route::get('/products/import/guide', [ProductImportController::class, 'getGuide']);
