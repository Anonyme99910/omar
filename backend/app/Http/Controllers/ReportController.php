...
class ReportController extends Controller
{
    public function dashboard()
    {
        ...
        // Total inventory net worth (using production cost)
        $inventoryNetWorth = Product::selectRaw('SUM(quantity * production_cost) as total')
            ->first()
            ->total ?? 0;
        ...
        // Stock cost and potential profit
        $stockCost = $inventoryNetWorth; // Same as net worth
        
        $potentialProfit = $inventoryValue - $stockCost;
